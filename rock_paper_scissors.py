...
multiplayer = input('Lets play a game of rock paper scissors!\n\nDo you have a friend to play with? Y or N? ')
...
while play_again == 'y':
    ...
    if (p1_guess in options):
        ...
        if (p2_guess in options):
            ...
            elif (p1_guess == 'rock' and p2_guess == 'scissors') or (p1_guess == 'paper' and p2_guess == 'rock') or (p1_guess == 'scissors' and p2_guess == 'paper'):
